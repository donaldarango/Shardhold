...
public class MapGenerator : MonoBehaviour
{
    ...
    //this should all be in MapManager post-demo/showcase 1
    //public int range = 4; //leaving this here to make my job easier for this round - will cut with more time
            ...
            if (tileName.StartsWith("Tile_R"))
            {
                ...
                if (Input.GetMouseButtonDown(0)) // Left click
                {
                    ...
                    else // If there isn't a red highlight, this is the first selection.
                    {
                        ...
                        targetedTiles.Clear();
                        PlayCard?.Invoke(clickedTiles);
                        //SelectTileSet?.Invoke(this, new SelectTileSetEventArgs(clickedTiles));
                    }
                }
            }
        }
